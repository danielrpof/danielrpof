...
USER_NAME = os.environ['danielrpof'] # 'danielrpof'
...
if __name__ == '__main__':
    """
    Daniel Restrepo (danielrpof), 2022-2025
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': '127344630'} and 2019-11-03T21:15:07Z for username 'danielrpof'
    ...
    if OWNER_ID == {'id': '127344630'}: # only calculate for user danielrpof
